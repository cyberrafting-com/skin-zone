...
$(function() {
    ...
    $('.service-sidebar .sidebar-widget .category-list li .list [href="' + url + '"]').parent().removeClass('active');

    // Will also work for relative and absolute hrefs
    $('.service-sidebar .sidebar-widget .category-list li .list').filter(function() {
